...
const styles = StyleSheet.create({
  ...
  ordersContainer: { flex: 1, backgroundColor: "#2E2E3A" },
  ...
  chaseButtonText: { color: "#00A3FF", fontSize: 12 },
  cancelButtonSmall: {
    backgroundColor: "#333",
    paddingHorizontal: 12,
    paddingVertical: 4,
  ...
  positionsContainer: { flex: 1, backgroundColor: "#2E2E3A" },
  positionItem: {
    backgroundColor: "#1E1E2F",
    margin: 8,
    borderRadius: 4,
  ...
  tpslButton: { backgroundColor: "#333", padding: 6, borderRadius: 3 },
  tpslText: { color: "#FFF", fontSize: 12 },
  closeButton: { backgroundColor: "#FF3B30", padding: 6, borderRadius: 3 },
